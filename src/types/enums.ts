...
export enum ErrorCode {
    ...
    USER_ALREADY_LOGGED_OUT = "400:USER_ALREADY_LOGGED_OUT",
    DECODED_TOKEN_MALFORMED = "400:DECODED_TOKEN_MALFORMED",
    ...
    TOKEN_MALFORMED = "401:TOKEN_MALFORMED",
    TOKEN_REFRESH_FAILED = "401:TOKEN_REFRESH_FAILED",
    TOKEN_INVALID = "401:TOKEN_INVALID",
    HEADER_TOKEN_MISSING = "401:HEADER_TOKEN_MISSING",
    ACCESS_TOKEN_EXPIRED = "401:ACCESS_TOKEN_EXPIRED",
    REFRESH_TOKEN_EXPIRED = "401:REFRESH_TOKEN_EXPIRED",
    REFRESH_TOKEN_MISSING = "401:REFRESH_TOKEN_MISSING",
    REQ_USERID_NOT_FOUND = "401:REQ_USERID_NOT_FOUND",
    ...
    INSECURE_CONNECTION = "403:INSECURE_CONNECTION",
    ...
    VERIFICATION_TOKEN_MISSING = "500:VERIFICATION_TOKEN_MISSING",
    VERIFICATION_TOKEN_MISSING_DATA = "500:VERIFICATION_TOKEN_MISSING_DATA",
